...
public class MemberForm extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkBox = (CheckBox) findViewById(R.id.checkboxHead);
        ...
        pushLocal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (famId.equals("") || name.equals("") || age.equals("") || childId.equals("")) {
                    ...
                    Member member = new Member(Integer.parseInt(famId),isHead, name, Integer.parseInt(age),
                    ...
                    try {
                        long result = db.createMember(member, 1);
